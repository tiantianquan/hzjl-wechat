...
//省
var provinces = ['天津', '北京', '山东', '山西', '辽宁', '内蒙古', '河北'];

var citys = ["石家庄", "邯郸", "廊坊", "邢台", "承德", "沧州", "呼和浩特", "保定", "秦皇岛", "唐山", "济南", "青岛", "威海", "烟台", "德州", "呼伦贝尔", "东营", "淄博", "潍坊", "聊城", "滨州", "滕州", "枣庄", "安阳", "锡林郭勒盟", "大连", "沈阳", "阜新", "锦州", "朝阳", "铁岭", "丹东", "盘锦", "通辽", "葫芦岛", "抚顺", "本溪", "长治", "忻州", "朔州", "乌海", "赤峰"]
